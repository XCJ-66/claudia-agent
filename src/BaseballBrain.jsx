...
async function speak(text, onStart, onEnd) {
  ...
  try {
    ...
    const audio = document.getElementById("honus-audio") || Object.assign(document.createElement("audio"), {id: "honus-audio"});document.body.contains(audio) || document.body.appendChild(audio);audio.src = url
    audio.volume = 1.0;
